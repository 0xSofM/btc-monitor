        ...
        records.append(
            {
                ...
                "thresholds": {
                    ...
                    "lthSopr": {
                        "trigger": _safe_float(getattr(row, "lth_sopr_trigger")),
                        "deep": _safe_float(getattr(row, "lth_sopr_deep")),
                    },
                    "mvrvZscoreCore": THRESHOLD_STATIC["mvrv_zscore"],
                    "nuplCore": THRESHOLD_STATIC["nupl"],
...
def build_latest_json(
    ...
    latest_payload: Dict[str, object] = {
        ...
        "sthSoprMa3": _safe_float(last.get("sth_sopr_ma3")),
        "lthSopr": _safe_float(last.get("lth_sopr")),
        "lthSoprMa3": _safe_float(last.get("lth_sopr_ma3")),
